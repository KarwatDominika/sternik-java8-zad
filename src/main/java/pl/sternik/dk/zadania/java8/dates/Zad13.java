package pl.sternik.dk.zadania.java8.dates;
...
public class Zad13 {
	...
	public static void main(String[] args) {
        ...
        Instant later = now.plusSeconds(60).plusMillis(20).plusNanos(20);
        ...
        System.out.println("ZonedDateTime to Instant plus strefa czasowa");
